...
void DisplayClass::Initialize(bool reboot) {
  #ifdef I2C_PORT_OLED
    OLED.initialize(reboot ? OLED_INIT_NO_REGS_MASK : OLED_INIT_ROTATE180_MASK, I2C_HIGH_CLOCK_SPEED);
  #else
    OLED.initialize(reboot ? OLED_INIT_NO_REGS_MASK : OLED_INIT_ROTATE180_MASK, SPI_OLED_CLOCK_SPEED);
  #endif
