...
//const ssd1306_font_descriptor_t font_8x8_descriptor[96+47] = {
  ...
  7,0,F_OFFS(123), // hex 0x9B, ASCII 'cent'
  7,0,F_OFFS(124), // hex 0x9C, ASCII 'pound'
  6,1,F_OFFS(125), // hex 0x9D, ASCII 'yen'
  8,0,F_OFFS(126), // hex 0x9E, ASCII 'peseta'
  8,0,F_OFFS(127), // hex 0x9F, ASCII 'florin'
...
static const uint8_t font_5x8_data[0xB0-0x20][5] = {
  ...
  { 0x38, 0x55, 0x56, 0x54, 0x18 },  // è
	...
	{ 0x00, 0x20, 0x20, 0x20, 0x38 },  // _|
	{ 0x00, 0x38, 0x20, 0x20, 0x20 },  // |_
